...
class Skylake final : public LinearMapperBase, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, Skylake, "Skylake", "Applies a Skylake mapping to the address.");
  ...
  public:
    ...
    // modify this to reflect address mapping used in Skylake... 
    void apply(Request& req) override {
      req.addr_vec.resize(m_num_levels, -1);
      Addr_t addr = req.addr >> m_tx_offset;
